<template>
  ...
  <ServicesList :services="services" :specializations="specializations" />
  <Modal v-if="showAddServiceModal" @close="showAddServiceModal = false">
    <template #body>
            ...
            <div class="grid grid-cols-2 gap-x-6 gap-y-5 lg:grid-cols-2">
              ...
              <div>
                ...
                <div class="relative z-20 bg-transparent">
                  ...
                  >
                    <option v-for="spec in specializations" :key="spec.id" :value="spec.id" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                      {{ spec.name }}
                    </option>
                  </select>
                  <span
...
const hasAddServicePermission = computed(() => {
  return authStore.user?.permissions?.includes("add service") ?? false
})
